...
contract ChronoBankAssetWithFee is ChronoBankAsset, Owned {
    ...
    /// @notice Transfers asset balance from the specified sender to specified receiver adding specified comment.
    ///
    ...
    /// @notice Performs allowance transfer of asset balance from the specified payer to specified receiver
    ...
    /// @notice Transfers fee from the specified payer to fee collecting address.
    ///
    ...
    /// @notice Check if specified payer and amount are subjects to fees.
    ///
    /// Fee is not taken if:
